"""
Django settings for piizahut project.
...
SECRET_KEY = 'django-insecure-0f6c66m9zz-p1al6i&amo_f)^=xbb90((tc@t&qcb(j7dq3^&n'
...
WSGI_APPLICATION = 'piizahut.wsgi.application'
